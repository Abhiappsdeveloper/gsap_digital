...
(function () {
  ...
  const ribbedMat = new THREE.MeshStandardMaterial({ color: 0x2233bb, metalness: 0.9, roughness: 0.25, emissive: 0x0a1466, emissiveIntensity: 0.4 });
  ...
  const prismMat = new THREE.MeshStandardMaterial({ color: 0x0e8f7d, metalness: 0.75, roughness: 0.3, emissive: 0x043c33, emissiveIntensity: 0.5, flatShading: true });
  ...
  const shellMat = new THREE.MeshStandardMaterial({ color: 0x1c2b3a, metalness: 0.8, roughness: 0.35, side: THREE.DoubleSide, emissive: 0x08131c, emissiveIntensity: 0.5 });
